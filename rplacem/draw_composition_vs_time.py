...
#file_size_bmp, file_size_png, t_inds_list = cp.save_part_over_time(canvas_area, time_interval, total_time=TIME_TOTAL, part_name=part_name, delete_bmp=True, delete_png=False, show_plot=False)

th.stability(canvas_area,[0,TIME_WHITEONLY],part_name)
