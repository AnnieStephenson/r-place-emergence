...
def stability(cpart,
    ...
    for i in range(1, len(t_lims)):
        ...
        time_spent_in_color[i-1, :, :], current_color = calc_time_spent_in_color(cpart, t_win_start, t_win_end, current_color)
        ...
        # TODO: here until save_pickle should be its own calc_stability fcn
