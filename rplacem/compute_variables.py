...
def stability(cpart,
    ...
    previous_stable_colors = cpart.white_image(1) # remember stable image from previous t_step
...
def num_changes_and_users(cpart, t_lims, ref_image, save_ratio_pixels, save_ratio_images, simple_notrans=False):
    '''
